 ...
 */
public class StoreOtherUser extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final RatingBar ratingBarUsers = (RatingBar)view.findViewById(R.id.rbUsuariosStar);

        ratingBarUsers.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            @Override
